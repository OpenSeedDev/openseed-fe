...
import type { Availability, LoginInput, ProfileUpdateInput, SessionUser, SignupInput } from '../model/auth.types'
export const authApi={
  ...
  updateProfile:(input:ProfileUpdateInput)=>request<SessionUser>('/auth/profile',{method:'PATCH',body:JSON.stringify(input)}),
